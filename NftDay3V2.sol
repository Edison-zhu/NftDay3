...
contract JianLiBaoDay3 is ERC721Enumerable, Ownable {
    using Strings for uint256;
    //开始发售
    ...
    function preSalemint(uint256 tokenQuantity, address userAddress) public payable {
    ...
    //设置白名单
    function setWhiteList(address userAddress, bool _states){
